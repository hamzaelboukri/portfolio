...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    name: "Musify",
    tagline:
      "Music streaming platform — playlist builder, audio player & personalised artist discovery feed.",
    tags: ["React", "TypeScript", "Web Audio API", "Tailwind"],
    lang: "TypeScript",
    year: "2026",
  ...
  },
  {
    ...
    name: "Eventify",
    tagline:
      "Event discovery & booking — browse, register and manage events with a full attendee dashboard.",
  ...
  },
  {
    ...
    name: "MarketPlace",
    tagline:
      "Full-stack e-commerce — product listings, cart flow, seller portal & order management.",
  ...
  },
  {
    ...
    name: "Game Store v2",
    tagline:
      "Gaming e-commerce store — browseable catalogue, cart, wishlist & checkout flow.",
    tags: ["JavaScript", "React", "Redux", "Stripe"],
    lang: "JavaScript",
    year: "2025",
